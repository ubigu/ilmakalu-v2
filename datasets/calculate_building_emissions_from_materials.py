...
gdf_buildings = gpd.read_postgis(sql_buildings, con, geom_col=building_geom_col)  
...
gdf_grid = gpd.read_postgis(sql_grid, con, geom_col=grid_geom_column)
...
# aggregate years to decades and rename column to 'decade'
gdf_buildings_xyind['year'] = [((x//10)*10) for x in gdf_buildings_xyind['year']]
gdf_buildings_xyind= gdf_buildings_xyind.rename(columns={'year':'decade'})
