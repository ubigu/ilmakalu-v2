...
Revision ID: a2d00dad3fc6
Revises: 30e2e5e7b557
Create Date: 2024-09-16 12:38:08.248460
...
def upgrade() -> None:
    ...
    sa.Column('scenario', sa.String(), nullable=False),
    sa.Column('rakv', sa.Integer(), nullable=False),
    sa.Column('rakennus_tyyppi', sa.String(), nullable=False),
    ...
    sa.Column('mun', sa.String(), nullable=False),
    sa.Column('year', sa.Integer(), nullable=False),
    sa.Column('erpien', sa.Float(), nullable=False),
    sa.Column('rivita', sa.Float(), nullable=False),
    sa.Column('askert', sa.Float(), nullable=False),
    ...
    sa.Column('keskustyyp', sa.String(), nullable=False),
    sa.Column('keskusnimi', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    schema='delineations'
    )
    op.create_table('grid',
    sa.Column('WKT', sa.String(), nullable=False),
    sa.Column('xyind', sa.String(), nullable=False),
    ...
    sa.Column('scenario', sa.String(), nullable=False),
    sa.Column('year', sa.Integer(), nullable=False),
    sa.Column('metodi', sa.String(), nullable=False),
    sa.Column('paastolaji', sa.String(), nullable=False),
    ...
    sa.Column('scenario', sa.String(), nullable=False),
    sa.Column('rakennus_tyyppi', sa.String(), nullable=False),
    sa.Column('lammitysmuoto', sa.String(), nullable=False),
    sa.Column('kaukolampo', sa.Float(), nullable=False),
    sa.Column('kevyt_oljy', sa.Float(), nullable=False),
    sa.Column('kaasu', sa.Float(), nullable=False),
    sa.Column('sahko', sa.Float(), nullable=False),
    ...
    sa.Column('mun', sa.String(), nullable=False),
    sa.Column('mun_name', sa.String(), nullable=False),
    ...
    sa.Column('xyind', sa.String(), nullable=False),
    sa.Column('rakv', sa.Integer(), nullable=False),
    sa.Column('energiam', sa.String(), nullable=False),
    ...
    op.create_table('clc',
    sa.Column('vuosi', sa.Integer(), nullable=False),
    sa.Column('kunta', sa.String(), nullable=False),
    ...
    sa.Column('xyind', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('vuosi', 'xyind'),
    schema='grid_globals'
    )
    op.create_table('pop',
    sa.Column('vuosi', sa.Integer(), nullable=False),
    ...
    sa.Column('mun', sa.String(), nullable=False),
    sa.Column('hlt_table', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('mun'),
    schema='traffic'
    )
    ...
    sa.Column('scenario', sa.String(), nullable=False),
    sa.Column('year', sa.Integer(), nullable=False),
    sa.Column('kmuoto', sa.String(), nullable=False),
